...
def parse_args():
    ...
    parser.add_argument('--model', default='CSLP_FMLP', choices=["SASRec", "FMLP", "CSLP_SASRec", "CSLP_FMLP"])
    ...
    parser.add_argument('--gpu', default="-1", type=str, help="Assign memory to certain gpu")
